...
public class FileResource {
    ...
    @GetMapping("/view")
    public void view(@RequestParam(name="key") String key, HttpServletResponse httpServletResponse) throws IOException{

        S3Object s3Object = fileService.getFile(key);
        httpServletResponse.setContentType(s3Object.getObjectMetadata().getContentType());
        httpServletResponse.getOutputStream().write(s3Object.getObjectContent().readAllBytes());
    }
